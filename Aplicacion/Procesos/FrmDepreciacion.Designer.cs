namespace Aplicacion.Procesos
{
    partial class FrmDepreciacion
    {
        ...
        private void InitializeComponent()
        {
         ...
         this.dtDepreciacion.DefaultCellStyle = dataGridViewCellStyle1;
         ...
         this.dtDepAcum.DefaultCellStyle = dataGridViewCellStyle2;
         ...
         this.dtLibros.DefaultCellStyle = dataGridViewCellStyle3;
